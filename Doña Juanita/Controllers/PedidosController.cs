...
namespace Doña_Juanita.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NombreP,Nombre,Tipo,Descuento")] Pedidos pedidos)
        {
            ...
            ViewBag.Id = new SelectList(db.Clientes, "RutCli", "Nombre", pedidos.Id);
            ...
            ViewBag.Tipo = new SelectList(db.TipoCliente, "Tipo", "Tipo", pedidos.Tipo);
            return View(pedidos);
        }
